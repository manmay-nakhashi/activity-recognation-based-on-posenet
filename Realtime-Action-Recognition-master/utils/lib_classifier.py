...
class ClassifierOfflineTrain(object):
    ...
    def __init__(self):
        ...
        # self.clf = self._choose_model("AdaBoost")
    ...
    def _init_all_models(self):
        ...
        self.classifiers = [
            ...
            RandomForestClassifier(
                max_depth=30, n_estimators=200, max_features="auto"),
...
class ClassifierOnlineTest(object):
    ...
    def __init__(self, model_path, action_labels, window_size, human_id=0):
        ...
        self.THRESHOLD_SCORE_FOR_DISP = 0.2
    ...
    def predict(self, skeleton, model, model_keras):
        ...
        if is_features_good:
            ...
            if model_keras == True:
                ...
                curr_scores = model.predict(features)
                curr_scores = curr_scores.reshape(curr_scores.shape[1])
            else:
                curr_scores = model._predict_proba(features)[0]
